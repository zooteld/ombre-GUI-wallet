            ...
            <div class="row justify-between" style="max-width: 768px">
                ...
                <div class="infoBox">
                    <div class="infoBoxContent">
                        ...
                        <div class="value"><span><FormatOMB :amount="tx.amount" /></span></div>
                    </div>
                </div>
                ...
                <div class="infoBox">
                    <div class="infoBoxContent">
                        ...
                        <div class="value"><span><FormatOMB :amount="tx.fee" /></span></div>
                    </div>
                </div>
                    ...
                    <template v-if="out_destinations">
                        <q-item class="q-px-none" v-for="destination in out_destinations">
                            ...
                            <q-item-main>
                                ...
                                <q-item-tile sublabel><FormatOMB :amount="destination.amount" /></q-item-tile>
                            </q-item-main>
...
import FormatOMB from "components/format_omb"
export default {
    name: "TxDetails",
    computed: mapState({
